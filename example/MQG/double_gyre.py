...
n_steps = int(365 * 24 * 3600 / dt) + 1
freq_log = 1000
n_steps_save = int(10 * 365 * 24 * 3600 / dt) + 1
n_steps_save = int(182 * 24 * 3600 / dt) + 1
...
for n in trange(1, n_steps + 1):
    ...
    if freq_plot > 0 and (n % freq_plot == 0 or n == n_steps):
        ...
        plt.savefig(f"{output_dir}/visu/step_{n}.png")
        plt.close()
    ...
    if freq_save > 0 and n > n_steps_save and n % freq_save == 0:
        n_years, n_days = int(t // (365 * 24 * 3600)), int(
            t % (365 * 24 * 3600) // (24 * 3600)
        )
